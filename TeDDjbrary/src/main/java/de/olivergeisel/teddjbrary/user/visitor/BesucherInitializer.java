...
import de.olivergeisel.teddjbrary.user.UserVerwaltung;
...
@Component
public class BesucherInitializer implements DataInitializer {

	private final UserAccountManagement userAccountManagement;
	private final UserVerwaltung        userManager;

	public BesucherInitializer (UserAccountManagement userAccountManagement, UserVerwaltung userManager) {
