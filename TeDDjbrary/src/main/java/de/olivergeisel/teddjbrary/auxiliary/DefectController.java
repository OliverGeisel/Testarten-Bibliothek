...
public class DefectController {
	...
	private static final String BIBLIOTHEKAR_JOB_HTML = """
	...
	public String newBewerbung(@RequestParam String name, @RequestParam String email, @RequestParam String message,
			@RequestParam String job, Model model) {
		model.addAttribute("name", name);
		model.addAttribute("email", email);
		model.addAttribute("message", message);
		model.addAttribute("job", job);
		model.addAttribute("description", BIBLIOTHEKAR_JOB_HTML);
